...
functionBody
    :    '=>' { this.startNonAsyncFunction(); } expression { this.endFunction(); } ';'
    |    { this.startNonAsyncFunction(); } block { this.endFunction(); }
    |    ASYNC '=>'
         { this.startAsyncFunction(); } expression { this.endFunction(); } ';'
    |    (ASYNC | ASYNC '*' | SYNC '*')
         { this.startAsyncFunction(); } block { this.endFunction(); }
    ;
...
functionExpressionBody
    :    '=>' { this.startNonAsyncFunction(); } expression { this.endFunction(); }
    |    ASYNC '=>' { this.startAsyncFunction(); } expression { this.endFunction(); }
    ;
...
functionExpressionWithoutCascadeBody
    :    '=>' { this.startNonAsyncFunction(); }
         expressionWithoutCascade { this.endFunction(); }
    |    ASYNC '=>' { this.startAsyncFunction(); }
         expressionWithoutCascade { this.endFunction(); }
    ;
...
identifierNotFUNCTION
    ...
    |    { this.asyncEtcPredicate(this.currentToken.type) }? (AWAIT|YIELD)
    ;
