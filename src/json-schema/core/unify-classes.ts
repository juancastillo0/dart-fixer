...
import { setUnionInto, iterableFirst } from "collection-utils";
...
import { assertIsObject } from "quicktype-core/dist/TypeUtils";
import { TypeRefUnionAccumulator, UnionBuilder } from "./union-builder";
