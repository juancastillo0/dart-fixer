...
} from "quicktype-core/dist/Transformers";
import {
  isPrimitiveStringTypeKind,
  targetTypeKindForTransformedStringTypeKind,
  isNumberTypeKind,
} from "quicktype-core/dist/Type";
import { TypeGraph, typeRefIndex } from "quicktype-core/dist/TypeGraph";
import {
  minMaxLengthForType,
  minMaxValueForType,
} from "../rewrites/attributes-contraints";
...
function replaceUnion(
  ...
  const transformerForObject =
    transformerForClass !== undefined ? transformerForClass : transformerForMap;
