// https://github.com/ajv-validator/ajv/blob/35034b6b1bbaf144595713d50415501138db0036/lib/types/jtd-schema.ts
/** numeric strings */
type NumberType =
  | "float32"
  | "float64"
...
type IsRecord<T, Union extends boolean> = Union extends IsUnion<
  Exclude<T, null>
>
...
> = (
  ...
  | ((true extends NullTypeEquality<T, number>
      ...
      ? { enum: Array<EnumString<Exclude<T, null>>> }
